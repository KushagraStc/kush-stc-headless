            ...
            <header role='banner' className="bg-primary/80 dark:bg-contrast/60 text-contrast dark:text-primary  hidden h-nav lg:flex items-center sticky transition duration-300 backdrop-blur-lg z-40 top-0 justify-around w-full leading-none gap-8 px-12 py-6 h-32	">
                ...
                <div className="flex items-center w-2/3 h-2/3">
                    <form action="/search" className="flex items-center w-3/4 h-full">
                        <input type="search" placeholder="Search" name="q" className="bg-transparent hidden md:inline-block text-left lg:text-right border-b transition border-transparent -mb-px border-x-0 border-t-0 appearance-none px-0 py-1 focus:ring-transparent placeholder:opacity-20 placeholder:text-inherit focus:border-contrast/20 dark:focus:border-primary/20 h-full w-3/4" />
                ...
                <nav className="flex gap-14 navtest">
                    ...
                    <div className="dropdown" style={{ float: "left" }}>
                        ...
                        <div className="dropdown-content" >
                            ...
                            <a target="_self" href="/products">BEST SELLERS</a>
                            <a target="_self" href="/products">products2</a>
                            <a target="_self" href="/products">products3</a>
                            <a target="_self" href="/products">products4</a>
                        </div>
                    </div>
                 
                    <a target="_self" href="/pages/contact">BEST SELLERS</a>
                    <a target="_self" href="/pages/contact">COLLECTIONS</a>
                    <a target="_self" href="/pages/contact">THE GIFT SHOP</a>
                    <a target="_self" href="/pages/contact">SHOP INSTAGRAM</a>
                    <a target="_self" href="/pages/contact">WINTER WEAR'2022</a>
                    <div className="dropdown" style={{ float: "left" }}>
                        <button className="dropbtn">SALE</button>
                        <div className="dropdown-content" >
                            <div className="dropbtn2"><button>content-24</button>
                                <div className="dropdown2 " style={{ float: "left" }}>

                                    <div className="dropdown-content2" >
                                        <a target="_self" href="/products">products5
                                       </a>
                                        <a target="_self" href="/products">products6</a>
                                        <a target="_self" href="/products">products7</a>
                                        <a target="_self" href="/products">products8</a>
                                        <a target="_self" href="/products">products9</a>
                                    </div>
                                </div></div>

                            <a target="_self" href="/products">products1</a>
                            <a target="_self" href="/products">products2</a>
                            <a target="_self" href="/products">products3</a>
                            <a target="_self" href="/products">products4</a>
                        </div>
